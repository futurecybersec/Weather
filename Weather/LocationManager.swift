...
final class LocationManager: NSObject, CLLocationManagerDelegate, ObservableObject {
    ...
    func checkLocationAuthorization() {
        ...
        case .authorizedAlways://This authorisation allows you to use all location services and receive location events whether or not your app is in use.
            print("Location authorizedAlways")
            
        case .authorizedWhenInUse://This authorisation allows you to use all location services and receive location events only when your app is in use
            print("Location authorised when in use")
